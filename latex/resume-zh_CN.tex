...
\begin{itemize}
  \item 针对双手交互造成的严重遮挡问题，提出了一种新的关节热图表示方法。比起传统的关节热图，所提出的方法能够将交互区域的关节自适应地映射到热图上；
  \item 现有的方法大多数基于images-paired的方式进行训练，一定程度上影响了模型的泛化性。通过构建与图像无关的交互先验，能够有效利用更多的多模态数据集，进而提升泛化性；
