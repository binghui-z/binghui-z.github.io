...
Computer vision and computer graphics, especially in hand 3D reconstruction. Current interests mainly around generative models and neural rendering.
...
Advisor: \href{https://www.yangangwang.com/}{Prof.Yangang Wang}\\
GPA:~3.4/4
...
\textbf{Reconstructing Interacting Hands with Interaction Prior from Monocular Images~~(Under Review)}\\
\emph{\myname, Zimeng Zhao, Wenqian Sun, Wei Xie, Chao Wen, Yangang Wang} 

\textbf{Implicit Representation for Interacting Hands Reconstruction from Monocular Color Images~~(Under Review)} \\
